...
# Parsing + Configuration Script – AXE CO2 M 1.0 - Rev. A

This **Parsing + Configuration** script is designed for the **AXE CO2 M 1.0** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AXE CO2 M 1.0 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AXE CO2 M 1.0** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
